...
<a href="http://www.nohttp.net/" target="_blank">NoHttp</a>

>NoHttp，一个有情怀的框架。

<a href="https://github.com/kevinsawicki/http-request" target="_blank">http-request</a>
...
<a href="https://github.com/mcxiaoke/android-volley" target="_blank">volley</a>
...
<a href="https://github.com/ryanhoo/PhotoCropper" target="_blank">PhotoCropper</a>

>最佳选择裁剪在Android设备上的照片，尤其是大尺寸的照片。这样可以帮助您避免OOM（内存溢出）异常。

<a href="https://github.com/davemorrissey/subsampling-scale-image-view" target="_blank">subsampling-scale-image-view</a>

>与平移和缩放手势高度可配置的，易于扩展视图没有细节损失巨大的显示图像。完美的照片画廊，地图，建设计划等。

<a href="https://github.com/jdamcd/android-crop" target="_blank">android-crop</a>

>Android的库项目用于裁剪图像

<a href="https://github.com/edmodo/cropper" target="_blank">cropper</a>

>Android小工具进行裁剪和旋转图像。

<a href="https://github.com/MikeOrtiz/TouchImageView" target="_blank">TouchImageView</a>

>增加了触摸功能到Android ImageView上。

<a href="https://github.com/sephiroth74/ImageViewZoom" target="_blank">ImageViewZoom</a>

>Android的ImageView的小部件缩放和平移功能

<a href="https://github.com/qiujuer/ImageBlurring" target="_blank">ImageBlurring</a>

>Android Blurring Image(Bitmap) By Java And JNI.

<a href="https://github.com/jasonpolites/gesture-imageview" target="_blank">gesture-imageview</a>

>Implements pinch-zoom, rotate, pan as an ImageView for Android 2.1+

<a href="https://github.com/Curzibn/Luban" target="_blank">Luban(鲁班)</a>
...
<a href="https://github.com/yangfuhai/ASimpleCache" target="_blank">ASimpleCache</a>

>ASimpleCache 是一个为android制定的 轻量级的 开源缓存框架。可以缓存普通的字符串、JsonObject、JsonArray、Bitmap、Drawable、序列化的java对象，和 byte数据。

<a href="https://github.com/hongyangAndroid/base-diskcache" target="_blank">base-diskcache</a>
...
<a href="https://github.com/Trinea/AndroidCommon" target="_blank">AndroidCommon</a>

>Trinea大神开源的包含缓存(图片缓存、预取缓存、网络缓存)、公共View(下拉及底部加载更多ListView、底部加载更多ScrollView、滑动一页Gallery)、及Android常用工具类(网络、下载、shell、文件、json等等)。

<a href="https://github.com/shwenzhang/AndResGuard" target="_blank">AndResGuard</a>
...
<a href="https://github.com/over140/OPlayer" target="_blank">OPlayer</a>

>Android平台基于Vitamio的开源播放器

<a href="https://github.com/ymback/BambooPlayer" target="_blank">BambooPlayer</a>

>一个轻量级、多格式、支持解析多个视频网站的绿色播放器

<a href="https://github.com/qdrzwd/VideoRecorder" target="_blank">VideoRecorder</a>

>android视频录制，模仿微视，支持按下录制、抬起暂停。进度条断点显示。

<a href="https://github.com/JackCho/AndroidVideoView" target="_blank">AndroidVideoView</a>

>Android自定义全屏VideoView，仿主流视频客户端

<a href="https://github.com/JeroenMols/LandscapeVideoCamera" target="_blank">LandscapeVideoCamera</a>

>强大的自定义Android相机与在视频质量和文件大小的精细控制，限制录音唯一的风景线。

<a href="https://github.com/yqritc/Android-ScalableVideoView" target="_blank">Android-ScalableVideoView</a>

>有喜欢的缩放类型的ImageView如fitCenter，centerCrop，centerTopCrop多的各种规模类型的Android纹理VideoView

<a href="https://github.com/xiongwei-git/AndroidVideoPlayer" target="_blank">AndroidVideoPlayer</a>
...
<a href="https://github.com/card-io/card.io-Android-SDK" target="_blank">card.io SDK for Android</a>
...
<a href="http://apistore.baidu.com/apiworks/servicedetail/957.html" target="_blank">地理区域识别</a>

>提供地理区域识别、地理位置标签查询等位置数据服务。

<a href="http://apistore.baidu.com/apiworks/servicedetail/146.html" target="_blank">文字识别</a>

>提供了整图文字检测、识别、整图文字识别、整图文字行定位和单字图像识别等功能。

<a href="http://apistore.baidu.com/astore/serviceinfo/1360.html" target="_blank">语音识别</a>

>包括在线语音识别、在线语音合成等。

<a href="http://apistore.baidu.com/astore/serviceinfo/28479.html" target="_blank">指纹识别</a>
